...
class QVVComponentsValidator:
    def __init__(self, data_source: TechDocDataSource):
        self.data_source: TechDocDataSource = data_source
    ...
    def valid_components_for_qvv_prod(self, qvv_production: QVVProduction, ref_date: datetime.date) -> Dict[str, List[Component]]:
        ...
        vehicle_aggregates: List[Component] = valid_vehicle_components.pop(ComponentGroupingType.Aggregate.name)
    ...
    def valid_cabin_aggr_components_for_qvv_prod(self, component: Component, qvv_production: QVVProduction,
        ...
        for code in self.data_source.cabin_codes_to_ignore:
    ...
    @staticmethod
    def get_valid_components_for_groupings(bm_data: BaumusterData, groupings: List[ComponentGroupingType], composition: List[str],
