...
from PDS_Extractors.TechDocValidation.QVVComponentsValidator import QVVComponentsValidator
...
from PDS_Extractors.Models.QVVProductionComponents import QVVProductionComponents


class ProductionAnalysis:

    def __init__(self, production: Production, data_source: AnalysisDataSource):
