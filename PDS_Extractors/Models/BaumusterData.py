...
class BaumusterData:
    ...
    def from_dict(cls, datadict):
        ...
        for grouping_dict in datadict[BaumusterData.JSONKeys.bm_grouping_list]:
            grouping_type = GroupingType.from_str(grouping_dict[BaumusterData.JSONKeys.grouping_type])
    ...
    def extract_grouping(self, grouping_type: GroupingType) -> List[Component]:
