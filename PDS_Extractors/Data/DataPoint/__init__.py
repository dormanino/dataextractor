...
class DataPoint:
    ...
    # Suffixes
    SUFFIX_data_agrmz_vehicles = '_PDS_AGRMZ_parsed_final_Vehicles'
    ...
    data_agrmz_vehicles = LatestFileVersion.latest_file_version('json', SUFFIX_data_agrmz_vehicles, current=path)
