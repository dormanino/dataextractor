...
class PdsNfcAGR:
    ...
    def screen(self):
        ...
        for bm in self.bm_set:
            ...
            self.mainframe.send_string(bm, 2, 46)
...
with open('C:\\Users\\vravagn\\PycharmProjects\\dataextractor\\PDS_Extractors\\' + date_string + '_PDS_KGS_AGR.json', 'w') as f:
