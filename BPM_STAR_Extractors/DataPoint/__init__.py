...
class DataPoint:
    ...
    # Filenames
    filename_bm_qvv_vol = '_bm_qvv_vol'
    filename_dict_end = '_dict_end'
    ...
    data_qvv_bm_vol = LatestFileVersion.latest_file_version(EXT_json, filename_bm_qvv_vol, PATH_DataFiles)
    data_bm_tot = LatestFileVersion.latest_file_version(EXT_json, '_bmvol_tot', PATH_DataFiles)
    data_final_dict = LatestFileVersion.latest_file_version(EXT_json, filename_dict_end, PATH_DataFiles)
